  ...
  return (
    <Fragment>
      <NextSeo
        ...
        canonical={`https://panteapaint.com/travels/${replaceSpacesAndHyphens(
          typeTitle
        )}`}
        openGraph={{
          type: "website",
          locale: "fa_IR",
          url: `https://panteapaint.com/travels/${replaceSpacesAndHyphens(
            typeTitle
          )}`,
          title: typeTitle,
          description: language ? "ماجراجو حرفه‌ای" : "Professional Adventurer",
        ...
        >
          {travelTypes.map((type, index) => (
            ...
            >
              ...
              {!language && index !== travelTypes.length - 1 && (
                <span
                  style={{
                    fontFamily: language ? "EnglishLight" : "EnglishLight",
                  }}
